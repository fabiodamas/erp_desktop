inherited rtReceberAberto: TrtReceberAberto
  Caption = 'Receber Em aberto'
  ClientHeight = 210
  ClientWidth = 338
  ...
  object qrpReceberAberto: TQuickRep [8]
    Left = -1064
    Top = 272
    Width = 1123
    Height = 794
    ...
    BeforePrint = qrpReceberAbertoBeforePrint
  ...
  object qrpResLocEmp: TQuickRep [13]
    Left = -976
    Top = 319
    Width = 1123
    Height = 794
  ...
  object qrpResLocalizacao: TQuickRep [14]
    Left = -904
    Top = 391
    Width = 1123
    Height = 794
  ...
  object tabAuxEmpresa: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 576
    Top = 168
    object tabAuxEmpresaCodEmp: TFloatField
      FieldName = 'CodEmp'
    end
    object tabAuxEmpresaNomeEmp: TStringField
      FieldName = 'NomeEmp'
      Size = 60
    end
    object tabAuxEmpresaValorTotal: TCurrencyField
      FieldName = 'ValorTotal'
    end
  end
  object qrcReceberAberto: TQRCompositeReport
    OnAddReports = qrcReceberAbertoAddReports
    OnFinished = qrcReceberAbertoFinished
    Options = []
    PrinterSettings.Copies = 1
    PrinterSettings.OutputBin = Auto
    PrinterSettings.Duplex = False
