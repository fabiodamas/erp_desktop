inherited fmLinhas: TfmLinhas
  Left = 288
  Top = 115
  Caption = 'Linhas & Refer'#234'ncias'
  ClientHeight = 439
  ClientWidth = 678
  OnShow = FormShow
  PixelsPerInch = 96
  ...
  object lbl1: TLabel [2]
    ...
    Width = 76
    Height = 13
    Caption = 'C'#243'digo Exibi'#231#227'o'
  end
  ...
  object edtCodigoLinha: TDBEdit [7]
    Left = 128
    Top = 22
    Width = 109
    Height = 21
    DataField = 'CodigoExibicao'
    DataSource = dtsBase
    TabOrder = 1
  end
  object pgcGrades: TPageControl [8]
    Left = 8
    Top = 48
    Width = 663
    Height = 321
    ...
    object tsLista: TTabSheet
      ...
      object dbgLinha: TcxGrid
        ...
        object tvwLinhas: TcxGridDBTableView
          OnDblClick = tvwLinhasDblClick
          NavigatorButtons.ConfirmDelete = False
          OnCellDblClick = tvwLinhasCellDblClick
          ...
          object clmGradesCodigoLinha: TcxGridDBColumn
            Caption = 'C'#243'digo'
            DataBinding.FieldName = 'CodigoLinha'
          end
          object clmGradesCodigoExibicao: TcxGridDBColumn
            Caption = 'C'#243'digo Exibi'#231#227'o'
            DataBinding.FieldName = 'CodigoExibicao'
            Width = 171
          end
          object clmLinhasDescricao: TcxGridDBColumn
            DataBinding.FieldName = 'Descricao'
          end
          object clmGradesAbreviacao: TcxGridDBColumn
            Caption = 'Abrevia'#231#227'o'
            DataBinding.FieldName = 'Abreviacao'
            Width = 176
          end
        end
        object tvwLinhaDBTableView1: TcxGridDBTableView
          NavigatorButtons.ConfirmDelete = False
          DataController.Summary.DefaultGroupSummaryItems = <>
          DataController.Summary.FooterSummaryItems = <>
          DataController.Summary.SummaryGroups = <>
        end
        object tvwReferencias: TcxGridDBTableView
          NavigatorButtons.ConfirmDelete = False
          DataController.DataSource = dtsReferencia
          DataController.DetailKeyFieldNames = 'CodigoLinha'
          DataController.KeyFieldNames = 'CodigoLinha'
          DataController.MasterKeyFieldNames = 'CodigoLinha'
          DataController.Summary.DefaultGroupSummaryItems = <>
          DataController.Summary.FooterSummaryItems = <>
          DataController.Summary.SummaryGroups = <>
          object clmReferenciasCodigoExibicao: TcxGridDBColumn
            DataBinding.FieldName = 'CodigoExibicao'
          end
          object clmReferenciasDescricao: TcxGridDBColumn
            DataBinding.FieldName = 'Descricao'
          end
        end
        object lvlLinhas: TcxGridLevel
          GridView = tvwLinhas
          object lvlReferencias: TcxGridLevel
            GridView = tvwReferencias
          end
        end
      end
    end
    object tsDetalhes: TTabSheet
      ...
      object cxGrid1: TcxGrid
        ...
        object cxGridDBTableView1: TcxGridDBTableView
          ...
          object clmGridDBTableView1CodigoExibicao: TcxGridDBColumn
            DataBinding.FieldName = 'CodigoExibicao'
            Width = 91
          end
  ...
  object edtCodigoExibicao: TDBEdit [9]
    Left = 544
    Top = 22
    Width = 109
    Height = 21
  ...
  inherited tabBase: TZQuery
    ...
    SQL.Strings = (
      'select * from linhas')
    object tabBaseCodigoLinha: TFloatField
      FieldName = 'CodigoLinha'
      Required = True
    end
    object tabBaseCodigoExibicao: TFloatField
      FieldName = 'CodigoExibicao'
      Required = True
    end
    ...
    object cdsBaseAbreviacao: TStringField
  ...
  object tabReferenciaDetalhes: TZQuery
    Connection = fmMenu.zcnConexao
    OnNewRecord = tabReferenciaDetalhesNewRecord
    Params = <>
    Left = 232
    Top = 224
    object tabReferenciaDetalhesCodigoReferencia: TFloatField
      FieldName = 'CodigoReferencia'
      Required = True
    end
    object tabReferenciaDetalhesCodigoExibicao: TFloatField
      FieldName = 'CodigoExibicao'
      Required = True
    end
    object tabReferenciaDetalhesCodigoLinha: TFloatField
      FieldName = 'CodigoLinha'
      Required = True
    end
    object tabReferenciaDetalhesDescricao: TWideStringField
      FieldName = 'Descricao'
      Size = 50
    end
  end
