inherited fmLocalizarCFOP: TfmLocalizarCFOP
  Left = 234
  Top = 152
  Caption = 'Localizar CFOP - Natureza de Opera'#231#227'o'
  ClientHeight = 398
  ClientWidth = 663
  OnShow = FormShow
  PixelsPerInch = 96
  ...
  object Label1: TLabel [1]
    ...
    FocusControl = edtNaturezaOperacao
  end
  object edtCFOP: TEdit [2]
    Left = 8
    Top = 24
    Width = 89
    Height = 21
  ...
  object edtNaturezaOperacao: TEdit [3]
    Left = 107
    Top = 24
    Width = 549
    Height = 21
    TabOrder = 1
    OnChange = edtNaturezaOperacaoChange
  end
  object dbgLocalizar: TDBGrid [4]
    Left = 8
    Top = 53
    Width = 648
    Height = 305
