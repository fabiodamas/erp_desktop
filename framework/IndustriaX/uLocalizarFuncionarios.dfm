inherited fmLocalizarFuncionarios: TfmLocalizarFuncionarios
  Left = 244
  Top = 122
  ...
  object edtDepartamento: TDBLookupComboBox [5]
    Left = 347
    Top = 24
    Width = 230
    Height = 21
    KeyField = 'Codigo'
    ListField = 'Descricao'
    ListSource = dtsDepartamentos
    TabOrder = 2
    OnCloseUp = edtDepartamentoCloseUp
  end
  object dbgLocalizarFuncionarios: TDBGrid [6]
    Left = 8
    Top = 56
    Width = 568
    Height = 392
    ...
    TitleFont.Style = []
    OnCellClick = dbgLocalizarFuncionariosCellClick
    Columns = <
      item
        Expanded = False
        FieldName = 'Codigo'
  ...
  object rdgStatusFuncionario: TRadioGroup [8]
    Left = 8
    Top = 451
    Width = 249
    Height = 36
    ...
    Items.Strings = (
      ...
      'Inativos')
    TabOrder = 5
    OnClick = rdgStatusFuncionarioClick
  end
  inherited popGrid: TPopupMenu
    Top = 112
  end
  object tabDepartamentos: TZQuery
