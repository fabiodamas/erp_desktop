...
type
  TfmFornecedores = class(TfmFormBaseCadastro)
    Label1: TLabel;
    Label2: TLabel;
    edtNomeFantasia: TDBEdit;
    edtFornecedorCodigo: TEdit;
    pgcFornecedores: TPageControl;
    tbsGeral: TTabSheet;
...
procedure TfmFornecedores.Editar;
begin
end;

procedure TfmFornecedores.Cancelar;
begin
end;

function TfmFornecedores.Checagens: Boolean;
begin
   Result:=False;
...
procedure TfmFornecedores.Deletar;
begin
end;

procedure TfmFornecedores.Novo;
begin 
   if Trim(edtFornecedorCodigo.Text) = '' then begin
...
procedure TfmFornecedores.AtualizaCodigoFornecedor;
begin
...
procedure TfmFornecedores.btnNovoClick(Sender: TObject);
begin
   inherited;
...
procedure TfmFornecedores.edtCnpjCpfExit(Sender: TObject);
begin
   inherited;
...
procedure TfmFornecedores.dtsBaseDataChange(Sender: TObject;
  Field: TField);
begin
   inherited;
...
procedure TfmFornecedores.edtCepExit(Sender: TObject);
begin
  inherited;
   if tabBase.State in [dsInsert, dsEdit] then begin
...
procedure TfmFornecedores.edtDepositoCepExit(Sender: TObject);
begin
   inherited;
   if tabBase.State in [dsInsert, dsEdit] then begin
...
procedure TfmFornecedores.edtCorrespondenciaCepExit(Sender: TObject);
begin
   inherited;
   if tabBase.State in [dsInsert, dsEdit] then begin
...
procedure TfmFornecedores.btnLocalizaCepClick(Sender: TObject);
...
procedure TfmFornecedores.btnDepositoLocalizaCepClick(Sender: TObject);
var vEndereco: TEndereco;
begin
   inherited;
   if tabBase.State in [dsInsert, dsEdit] then begin
...
procedure TfmFornecedores.btnCorrespondenciaLocalizaCepClick(Sender: TObject);
var vEndereco: TEndereco;
begin
   inherited;
   if tabBase.State in [dsInsert, dsEdit] then begin
...
procedure TfmFornecedores.edtFornecedorCodigoKeyUp(Sender: TObject;
...
procedure TfmFornecedores.btnLocalizarClick(Sender: TObject);
...
procedure TfmFornecedores.AtualizaCnpjCpf;
begin
   if tabBase.State in [dsInsert, dsEdit] then begin
...
procedure TfmFornecedores.btnCopiarDeEndNormalParaDepositoClick(
  Sender: TObject);
begin
   inherited;
   if tabBase.State in [dsInsert, dsEdit] then begin
...
procedure TfmFornecedores.btnCopiarEndNormalParaCorrespondenciaClick(
  Sender: TObject);
begin
   inherited;
   if tabBase.State in [dsInsert, dsEdit] then begin
...
procedure TfmFornecedores.btnCopiarEndDepositoParaCorrespondenciaClick(
  Sender: TObject);
begin
   inherited;
   if tabBase.State in [dsInsert, dsEdit] then begin
...
procedure TfmFornecedores.btnContatoAdicionarClick(Sender: TObject);
begin
   inherited;
   if tabBase.State in [dsInsert, dsEdit] then begin
...
procedure TfmFornecedores.btnEmailAdicionarClick(Sender: TObject);
begin
   inherited;
   if tabBase.State in [dsInsert, dsEdit] then begin
...
procedure TfmFornecedores.btnContatoRemoverClick(Sender: TObject);
begin
   inherited;
   if tabBase.State in [dsInsert, dsEdit] then begin
...
procedure TfmFornecedores.btnEmailRemoverClick(Sender: TObject);
begin
   inherited;
   if tabBase.State in [dsInsert, dsEdit] then begin
...
procedure TfmFornecedores.Rtulo1Click(Sender: TObject);
...
procedure TfmFornecedores.edtFornecedorCodigoKeyPress(Sender: TObject;
  var Key: Char);
begin
   inherited;
...
procedure TfmFornecedores.edtEmailNFeXMLClick(Sender: TObject);
begin
   inherited;
...
procedure TfmFornecedores.EnvioDeEmails(pEmail: string);
begin
   ShellExecute(0, 'open', Pchar('mailto:'+Trim(pEmail)), nil, nil, SW_SHOWNORMAL);
end;

procedure TfmFornecedores.AcessarSite(pSite: string);
begin
   ShellExecute(0, 'open', Pchar(Trim(pSite)), nil, nil, SW_SHOWNORMAL);
end;

procedure TfmFornecedores.edtSiteClick(Sender: TObject);
begin
   inherited;
...
procedure TfmFornecedores.edtEmailNFeDanfeClick(Sender: TObject);
begin
   inherited;
...
procedure TfmFornecedores.EnviarEmail1Click(Sender: TObject);
begin
   inherited;
...
procedure TfmFornecedores.dbrTipoFornecedorClick(Sender: TObject);
begin
   inherited;
