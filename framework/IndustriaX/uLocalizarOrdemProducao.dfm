inherited fmLocalizarOrdemProducao: TfmLocalizarOrdemProducao
  Left = 221
  Top = 120
  Caption = 'Localizar Ordem de Produ'#231#227'o'
  ClientHeight = 452
  ClientWidth = 835
  PixelsPerInch = 96
  TextHeight = 13
  ...
  object dbgOrdemProducao: TcxGrid [13]
    Left = 8
    Top = 96
    Width = 825
    Height = 321
    ...
    object tvwOrdemProducao: TcxGridDBTableView
      ...
      DataController.DataSource = dtsOrdemProducao
      DataController.Summary.DefaultGroupSummaryItems = <>
      DataController.Summary.FooterSummaryItems = <>
      DataController.Summary.SummaryGroups = <>
      object clmOrdemProducaoOrdemProducao: TcxGridDBColumn
        Caption = 'O.P.'
  ...
  object edtCodigoPedido: TEdit [14]
    Left = 104
    Top = 24
    Width = 89
    Height = 21
  ...
  object edtDataPrevisao: TDateEdit [17]
    Left = 391
    Top = 24
    Width = 89
    Height = 21
  ...
  object edtDataTermino: TDateEdit [18]
    Left = 486
    Top = 24
    Width = 89
    Height = 21
  ...
  object edtResponsavel: TEdit [20]
    Left = 197
    Top = 65
    Width = 188
    Height = 21
  ...
  object edtContato: TEdit [21]
    Left = 581
    Top = 25
    Width = 96
    Height = 21
    TabOrder = 11
    OnKeyUp = edtContatoKeyUp
  end
  object edtObservacao: TEdit [22]
    Left = 392
    Top = 64
    Width = 273
    Height = 21
  ...
  object btnExibirTodos: TBitBtn [23]
    Left = 541
    Top = 424
    Width = 93
    Height = 25
  ...
  object tabOrdemProducao: TZQuery
    ...
    SQL.Strings = (
      'select'
      '    ordem_producao . *, clientes.Razaosocial, funcionarios.nome'
      'from'
      '    ordem_producao,'
      '    clientes,'
      '    funcionarios'
      'where'
        ...
        '    clientes.CodigoCliente = ordem_producao.CodigoCliente'#10'    an' +
        'd funcionarios.Codigo = ordem_producao.CodigoFuncionario'
      ''
      'limit 1')
    Params = <>
    Left = 872
