inherited fmReEmissaoNFe: TfmReEmissaoNFe
  Left = 234
  Top = 154
  Caption = 'ReEmiss'#227'o da NFe'
  ClientHeight = 316
  ClientWidth = 478
  Scaled = False
  OnShow = FormShow
  ...
  object btnVisualizar: TBitBtn [12]
    Left = 383
    Top = 24
    Width = 87
    Height = 28
  ...
  object tabFornecedores: TZQuery
    Connection = fmMenu.zcnConexao
    Params = <>
    Left = 89
    Top = 544
