...
type
  TrtRotulos = class(TfmFormBaseRelatorio)
...
uses uFormBase, uMenu, uFuncoes, uLocalizarClientes;

{$R *.dfm}

procedure TrtRotulos.FormCreate(Sender: TObject);
begin
   inherited;
   SetFormStyle(fsMDIChild);
end;

procedure TrtRotulos.FormShow(Sender: TObject);
begin
   inherited;
...
procedure TrtRotulos.FormClose(Sender: TObject; var Action: TCloseAction);
begin
   tabBase.Close;
   tabRotulos.Close;
   inherited;
...
procedure TrtRotulos.btnVisualizarClick(Sender: TObject);
begin
   inherited;
   GerarImpressao();
end;

procedure TrtRotulos.GerarImpressao(Impressora: Boolean = False);
var vCnt : Integer;
begin
...
procedure TrtRotulos.btnImprimirClick(Sender: TObject);
begin
   inherited;
   GerarImpressao(True);
end;

procedure TrtRotulos.edtCodigoKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
   tabBase.Close;
...
procedure TrtRotulos.btnLocalizaClienteClick(Sender: TObject);
begin
