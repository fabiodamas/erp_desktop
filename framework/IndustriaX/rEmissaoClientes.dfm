inherited rtEmissaoClientes: TrtEmissaoClientes
  Left = 233
  Caption = 'Emiss'#227'o de Clientes'
  ClientHeight = 349
  ClientWidth = 336
  ...
  object qrpClientes: TQuickRep [12]
    Left = 8
    Top = 376
    Width = 1123
    Height = 794
    ...
    BeforePrint = qrpClientesBeforePrint
    Font.Charset = DEFAULT_CHARSET
  ...
  object ckbPaisDiferenteDe: TCheckBox [23]
    Left = 126
    Top = 97
    Width = 106
    Height = 17
    Caption = 'Pa'#237's Diferente De'
    TabOrder = 15
  end
